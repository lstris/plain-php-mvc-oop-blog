    ...
    <nav class="navbar">
      <div class="container-fluid">
        ...
        <div class="navbar-header">
          ...
          <a style="color: white; background-color: red" class="navbar-brand logo" href="<?php echo url('/'); ?>">Tuổi Trẻ</a>
        </div>
          ...
          <ul class="nav navbar-nav navbar-right">
            <?php if ($user) { ?>
              <li class="dropdown">
                ...
                <ul class="dropdown-menu">
                  <li>
                    <a href="<?php echo url('/admin/users') ?>">Tài Khoản</a>
                    <a href="<?php echo url('/admin/posts') ?>">Bài Viết</a>
