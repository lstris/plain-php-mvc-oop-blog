        ...
        <div class="col-sm-12">
          <div class="box box-danger" id="posts-list">
            <div class="box-header with-border">
              ...
              <button class="btn btn-danger pull-right open-popup" type="button" data-modal-target="#add-post-form" data-target="<?php echo url('/blog/posts/add'); ?>">Add New Post</button>
            </div>
            <!-- /.box-header -->
            <div class="box-body">
              <div id="results"></div>
                ...
                <?php foreach ($posts as $post) { ?>
                  <tr>
                    ...
                    <td style="vertical-align: middle;">
                      <button type="button" data-target="<?php echo url('blog/posts/edit/' . $post->id) ?>" data-modal-target="#edit-post-<?php echo $post->id; ?>" class="btn btn-primary open-popup">
                        Edit
                        <span class="fa fa-pencil"></span>
                      </button>
                      <button data-target="<?php echo url('blog/posts/delete/' . $post->id) ?>" class="btn btn-danger delete">
                        Delete
