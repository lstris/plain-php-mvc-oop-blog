...
$app->route->add('/blog/posts', 'Blog/Posts');
$app->route->add('/post/:user_id', 'Blog/Post');

$app->route->add('/blog/post', 'BLog/Post');
$app->route->add('/blog/posts/add', 'BLog/Posts@add', 'POST');
$app->route->add('/blog/posts/submit', 'BLog/Posts@submit', 'POST');
$app->route->add('/blog/posts/edit/:id', 'BLog/Posts@edit', 'POST');
$app->route->add('/blog/posts/save/:id', 'BLog/Posts@save', 'POST');
$app->route->add('/blog/posts/delete/:id', 'BLog/Posts@delete', 'POST');
